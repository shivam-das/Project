...
<body onload="initialize()">
    ...
    <div id="nav" >
    <h3>Enter A Segmented Trail:</h3>
    
      <form action="GT.php" name="concat" method="POST" enctype="multipart/form-data">  
        ...
        <input type="file" name="my_file"><br>
          ...
          <input type="submit" value="Ground Truth" class="button"><br>
...
<div id="map_canvas" style="width: 80%; height:800px; width: float:right; border: 0px solid;"></div>
